...
public class WorkerRosteringApp {
    ...
    public static String generate(int numberOfDays, String numberOfSpots) {
        EmployeeController ec = new EmployeeController();
        HashMap<String, Integer> spotMap = ec.getSpotsVariables();
        int numSpots = spotMap.get(numberOfSpots);
        WorkerRosteringGenerator.generateRoster(numberOfDays, numSpots);
        
        String path = "C:\\Users\\User\\Desktop\\DutyRoster1\\DutyRoster\\optaplanner-training-lab902-solution\\data\\workerrostering\\";
        String filename = "roster-"+numSpots+"spots-"+numberOfDays+"days";
        WorkerRosteringSolutionFileIO solutionFileIO = new WorkerRosteringSolutionFileIO();
        Roster roster = solutionFileIO.read(new File(path+"import\\" + filename + ".xlsx"));
