 ...
 * @author User
 */
@WebServlet(name = "DeleteUnavailableTimeSlotServlet", urlPatterns = {"/DeleteUnavailableTimeSlotServlet"})
public class DeleteUnavailableTimeSlotServlet extends HttpServlet {
